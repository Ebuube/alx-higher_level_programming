...
# Configuration for the 'stderred' program
# It colourizes stderr output in red
# Installed from <https://github.com/sickill/stderred>
export LD_PRELOAD="/home/vagrant/installations/stderred/build/libstderred.so${LD_PRELOAD:+:$LD_PRELOAD}"
